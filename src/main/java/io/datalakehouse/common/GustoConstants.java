...
public class GustoConstants {
    ...
    public static final class GustoHeaders {
        ...
        public static final String[] PAY_SCHEDULES_ASSIGNMENTS = {"PAY_SCHEDULES_ASSIGNMENTS_TYPE", "EMPLOYEES",
                ...
                "__DLH_IS_ACTIVE"};
        public static final String[] DEPARTMENT_PAY_SCHEDULES_ASSIGNMENTS = {"PAY_SCHEDULES_ASSIGNMENTS_TYPE",
                "DEPARTMENT_UUID","PAY_SCHEDULE_UUID","HOURLY_PAY_SCHEDULE_UUID",
                "SALARIED_PAY_SCHEDULE_UUID","DEFAULT_PAY_SCHEDULE_UUID",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] EMPLOYEE_PAY_SCHEDULES_ASSIGNMENTS = {"PAY_SCHEDULES_ASSIGNMENTS_TYPE",
                "EMPLOYEE_UUID","PAY_SCHEDULE_UUID","HOURLY_PAY_SCHEDULE_UUID","SALARIED_PAY_SCHEDULE_UUID",
                "DEFAULT_PAY_SCHEDULE_UUID","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS",
                "__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        ...
        public static final String[] EMPLOYEE_CUSTOM_FIELDS = {"ID","COMPANY_CUSTOM_FIELD_ID","NAME","DESCRIPTION",
                "EMPLOYEE_CUSTOM_FIELDS_TYPE","EMPLOYEE_CUSTOM_FIELD_VALUE","SELECTION_OPTIONS",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        ...
        public static final String[] JOBS = {"UUID","VERSION","EMPLOYEE_UUID","CURRENT_COMPENSATION_UUID",
                "PAYMENT_UNIT","JOBS_PRIMARY","TITLE","STATE_WC_COVERED","TWO_PERCENT_SHAREHOLDER",
                "STATE_WC_CLASS_CODE","RATE","HIRE_DATE","__ROW_MD5","__DLH_IS_DELETED",
                "__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] JOBS_COMPENSATIONS = {"UUID", "EMPLOYEE_UUID", "VERSION", "PAYMENT_UNIT", "FLSA_STATUS",
                ...
                "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] EMPLOYEE_BENEFITS = {"UUID","VERSION","EMPLOYEE_UUID",
                "COMPANY_BENEFIT_UUID","ACTIVE","EMPLOYEE_DEDUCTION","EMPLOYEE_DEDUCTION_ANNUAL_MAXIMUM",
                "COMPANY_CONTRIBUTION_ANNUAL_MAXIMUM","LIMIT_OPTION","DEDUCT_AS_PERCENTAGE","CATCH_UP",
                "COVERAGE_AMOUNT","RETIREMENT_LOAN_IDENTIFIER","DEDUCTION_REDUCES_TAXABLE_INCOME",
                "COVERAGE_SALARY_MULTIPLIER","CONTRIBUTION_TYPE","CONTRIBUTION_VALUE","EFFECTIVE_DATE",
                "EXPIRATION_DATE","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS",
                "__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        ...
        public static final String[] GARNISHMENTS = {"UUID", "VERSION", "EMPLOYEE_UUID", "ACTIVE", "AMOUNT",
                ...
                "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] CONTRACTORS = {"UUID","COMPANY_UUID","WAGE_TYPE","IS_ACTIVE","VERSION",
                "CONTRACTORS_TYPE","FIRST_NAME","LAST_NAME","MIDDLE_INITIAL","BUSINESS_NAME","EIN","HAS_EIN",
                "HAS_SSN","EMAIL","DEPARTMENT_UUID","DISMISSAL_DATE","DEPARTMENT_TITLE","START_DATE",
                "FILE_NEW_HIRE_REPORT","WORK_STATE","ONBOARDED","ONBOARDING_STATUS","PAYMENT_METHOD",
                "ADDRESS_STREET_1","ADDRESS_STREET_2","ADDRESS_CITY","ADDRESS_STATE","ADDRESS_ZIP",
                "ADDRESS_COUNTRY","HOURLY_RATE","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS",
                "__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
    ...
    public static final Map<String, String[]> CHILD_TABLE_HEADERS_BY_ENTITY = Map.ofEntries(
            Map.entry(GustoEntityNames.EMPLOYEE_PAY_SCHEDULE_ASSIGNMENTS, GustoHeaders.EMPLOYEE_PAY_SCHEDULES_ASSIGNMENTS),
            Map.entry(GustoEntityNames.DEPARTMENT_PAY_SCHEDULE_ASSIGNMENTS, GustoHeaders.DEPARTMENT_PAY_SCHEDULES_ASSIGNMENTS),
