...
public class OpenTableConnector extends DLHIngest {

    ObjectMapper mapper = new ObjectMapper();

    public OpenTableConnector(RestConnectionType type, DLHIngestConfig config, String outputPath) {
    ...
    /**
     * Override to support incremental page-by-page processing for OpenTable pagination.
     * This is the parent-aware version that the SDK calls.
     * For OpenTable, we ignore parent context as it's not needed.
     */
    @Override
