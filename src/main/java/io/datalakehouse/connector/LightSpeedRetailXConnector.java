...
public class LightSpeedRetailXConnector extends DLHIngest {
    public LightSpeedRetailXConnector(ConnectionTypeOptions type, DLHIngestConfig config, String outputPath) {
