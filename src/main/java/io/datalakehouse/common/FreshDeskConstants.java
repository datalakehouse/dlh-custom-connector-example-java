...
public class FreshDeskConstants {
    ...
    public static final class FreshDeskEntityNames {
        ...
        public static final String CANNED_RESPONSES_ATTACHMENTS = "CANNED_RESPONSES_ATTACHMENTS";
        ...
        public static final String SURVEYS_QUESTIONS = "SURVEYS_QUESTIONS";
    ...
    public static final class FreshDeskHeaders {
        ...
        public static final String[] ACCOUNT = {"ACCOUNT_ID","ORGANISATION_ID","ORGANISATION_NAME",
                "ACCOUNT_NAME","ACCOUNT_DOMAIN","BUNDLE_ID","HIPAA_COMPLIANT","TOTAL_AGENTS_FULL_TIME",
                "TOTAL_AGENTS_OCCASIONAL","TOTAL_AGENTS_FIELD_SERVICE","TOTAL_AGENTS_COLLABORATORS","ACCOUNT_TIMEZONE",
                "DATA_CENTER","TIER_TYPE","ADDRESS_COUNTRY","ADDRESS_STATE","ADDRESS_CITY","ADDRESS_STREET",
                "ADDRESS_POSTAL_CODE","CONTACT_PERSON_FIRSTNAME","CONTACT_PERSON_LASTNAME","CONTACT_PERSON_EMAIL",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] ADMIN_GROUPS = {"ID","NAME","DESCRIPTION","ESCALATE_TO","UNASSIGNED_FOR",
                "AGENT_IDS","CREATED_AT","UPDATED_AT","ALLOW_AGENTS_TO_CHANGE_AVAILABILITY","BUSINESS_CALENDAR_ID",
                "ADMIN_GROUPS_TYPE","AUTOMATIC_AGENT_ASSIGNMENT_ENABLED","AUTOMATIC_AGENT_ASSIGNMENT_TYPE",
                "AUTOMATIC_AGENT_ASSIGNMENT_SETTINGS","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS",
                "__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] AGENT = {"ID","AVAILABLE","OCCASIONAL","SIGNATURE","TICKET_SCOPE","CREATED_AT",
                "UPDATED_AT","AVAILABLE_SINCE","AGENT_TYPE", "LAST_ACTIVE_AT", "CONTACT_ACTIVE","CONTACT_EMAIL",
                "CONTACT_JOB_TITLE","CONTACT_LANGUAGE","CONTACT_LAST_LOGIN_AT","CONTACT_MOBILE","CONTACT_NAME",
                "CONTACT_PHONE","CONTACT_TIME_ZONE","CONTACT_CREATED_AT","CONTACT_UPDATED_AT","FOCUS_MODE",
                "DEACTIVATED", "AGENT_OPERATIONAL_STATUS",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        ...
        public static final String[] CANNED_RESPONSES = {"ID","TITLE", "FOLDER_ID", "CONTENT", "CONTENT_HTML"
                ,"CREATED_AT","UPDATED_AT", "GROUP_IDS", "VISIBILITY",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] CANNED_RESPONSES_ATTACHMENTS = {"ID", "CANNED_RESPONSES_ID", "NAME", "CONTENT_TYPE",
                "SIZE", "CREATED_AT","UPDATED_AT", "ATTACHMENT_URL", "THUMB_URL",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] COMPANIES = {"ID","NAME","DESCRIPTION","DOMAINS","NOTE","CREATED_AT","UPDATED_AT",
                "CUSTOM_FIELDS","HEALTH_SCORE","ACCOUNT_TIER","RENEWAL_DATE","INDUSTRY","ORG_COMPANY_ID",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] COMPANY_FIELDS = {"ID","NAME","LABEL","POSITION","REQUIRED_FOR_AGENTS",
                "AGENTS_CAN_EDIT","DISPLAYED_FOR_AGENTS","QUICK_ADD_FOR_AGENT","COMPANY_FIELDS_UNIQUE",
                "COMPANY_FIELDS_TYPE","COMPANY_FIELDS_DEFAULT","CREATED_AT","UPDATED_AT","CHOICES",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] CONTACT_FIELDS = {"ID","EDITABLE_IN_SIGNUP","NAME","LABEL","POSITION",
                "REQUIRED_FOR_AGENTS","AGENTS_CAN_EDIT","DISPLAYED_FOR_AGENTS","QUICK_ADD_FOR_AGENT",
                "CONTACT_FIELDS_UNIQUE","CONTACT_FIELDS_TYPE","CONTACT_FIELDS_DEFAULT","CUSTOMERS_CAN_EDIT",
                "LABEL_FOR_CUSTOMERS","REQUIRED_FOR_CUSTOMERS", "DISPLAYED_FOR_CUSTOMERS","CREATED_AT",
                "UPDATED_AT","__ROW_MD5","__DLH_IS_DELETED", "__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS",
                "__DLH_IS_ACTIVE"};
        public static final String[] CONTACTS = {"ID", "ACTIVE", "ADDRESS","COMPANY_ID", "DESCRIPTION",
                "EMAIL", "CONTACT_TYPE",  "JOB_TITLE", "LANGUAGE","MOBILE", "NAME", "PHONE", "TIME_ZONE",
                "FIRST_NAME", "LAST_NAME",
                "VISITOR_ID",  "ORG_CONTACT_ID", "ORG_CONTACT_ID_STR",
                "UNIQUE_EXTERNAL_ID", "PREFERRED_SOURCE", "OTHER_PHONE_NUMBERS", "SOCIAL_HANDLER",
                "CREATED_AT", "UPDATED_AT", "OTHER_COMPANIES", "CUSTOM_FIELDS",
                "__ROW_MD5", "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] DISCUSSION_CATEGORIES_FORUMS = {"ID","NAME","DESCRIPTION","POSITION",
                "FORUM_CATEGORY_ID","FORUM_TYPE","FORUM_VISIBILITY","TOPICS_COUNT","COMMENTS_COUNT",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] DISCUSSION_FORUMS_TOPICS = {"ID","TITLE","FORUM_ID","USER_ID","LOCKED",
                "PUBLISHED","STAMP_TYPE","REPLIED_BY","COMMENTS_COUNT","HITS","USER_VOTES","MERGED_TOPIC_ID",
                "STICKY","CREATED_AT","UPDATED_AT","REPLIED_AT","__ROW_MD5",
                "__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] DISCUSSION_TOPIC_COMMENTS = {"ID","BODY_TEXT","BODY","TOPIC_ID","FORUM_ID",
                "USER_ID","ANSWER","PUBLISHED","SPAM","TRASH","CREATED_AT","UPDATED_AT","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        ...
        public static final String[] EMAIL_MAILBOXES = {"ID","NAME","SUPPORT_EMAIL","GROUP_ID","DEFAULT_REPLY_EMAIL",
                "ACTIVE","MAILBOX_TYPE", "FAILURE_CODE", "CREATED_AT","UPDATED_AT","PRODUCT_ID",
                "DISABLE_VERIFY","FRESHDESK_MAILBOX_FORWARD_EMAIL", "CSAT_SETTINGS_SURVEY_ENABLED",
                "CSAT_SETTINGS_SURVEY_ID","CSAT_SETTINGS_MINIMUM_AGENT_RESPONSE_COUNT",
                "CSAT_SETTINGS_USER_RESPONSE_INTERVAL", "CSAT_SETTINGS_USER_RESPONSE_INTERVAL_UNIT",
                "CSAT_SETTINGS_SURVEY_EXPIRY_TIME","CSAT_SETTINGS_SURVEY_EXPIRY_TIME_UNIT",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] GROUPS = {"ID","NAME","DESCRIPTION","BUSINESS_HOUR_ID","ESCALATE_TO",
                "UNASSIGNED_FOR","AUTO_TICKET_ASSIGN","CREATED_AT","UPDATED_AT", "GROUP_TYPE",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] GROUPS_AGENTS = {"ID","TICKET_SCOPE","WRITE_ACCESS","ROLE_IDS","CONTACT_NAME",
                "CONTACT_EMAIL","CONTACT_AVATAR","CREATED_AT","UPDATED_AT","GROUPS_ID",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] PRODUCTS = {"ID","NAME","DESCRIPTION", "PRIMARY_EMAIL",
                "CREATED_AT","UPDATED_AT", "PRODUCTS_DEFAULT",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] ROLES = {"ID","NAME","DESCRIPTION","ROLES_DEFAULT","CREATED_AT","UPDATED_AT",
                "AGENT_TYPE", "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] SCENARIO_AUTOMATION = {"ID","NAME","DESCRIPTION","ACTIONS",
                "SCENARIO_AUTOMATION_PRIVATE","CREATED_AT","UPDATED_AT","__ROW_MD5","__DLH_IS_DELETED",
        ...
        public static final String[] SLA_POLICIES = {"ID","NAME","DESCRIPTION","ACTIVE","IS_DEFAULT","POSITION",
                "SLA_TARGET_PRIORITY_1","SLA_TARGET_PRIORITY_2","SLA_TARGET_PRIORITY_3","SLA_TARGET_PRIORITY_4",
                "APPLICABLE_TO","ESCALATION","CREATED_AT","UPDATED_AT","__ROW_MD5","__DLH_IS_DELETED",
                "__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] SOLUTIONS_CATEGORIES = {"ID","NAME","DESCRIPTION", "CREATED_AT","UPDATED_AT",
                "ICON", "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS",
        ...
        public static final String[] SURVEYS = {"ID","TITLE", "ACTIVE",
                "CREATED_AT","UPDATED_AT","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] SURVEYS_QUESTIONS = {"ID","SURVEYS_ID","LABEL","ACCEPTED_RATINGS",
                "SURVEYS_QUESTIONS_TYPE", "SURVEYS_QUESTION_DEFAULT", "__ROW_MD5","__DLH_IS_DELETED",
                "__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] TICKET_FIELDS = {"ID","DESCRIPTION","LABEL","NAME","POSITION","TICKET_FIELDS_TYPE"
                ,"LABEL_FOR_CUSTOMERS","TICKET_FIELDS_DEFAULT","REQUIRED_FOR_CLOSURE","REQUIRED_FOR_AGENTS",
                "REQUIRED_FOR_CUSTOMERS","CUSTOMERS_CAN_EDIT", "CUSTOMERS_CAN_FILTER", "DISPLAYED_TO_CUSTOMERS",
                "CREATED_AT","UPDATED_AT", "PORTAL_CC", "PORTAL_CC_TO",
                "CHOICES","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS",
                "__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] TICKET_FORMS = {"ID","NAME","TITLE","TICKET_FORMS_DEFAULT","DESCRIPTION",
                "CREATED_AT", "UPDATED_AT","LAST_UPDATED_BY","NON_EDITABLE","__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS",
                "__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] TICKETS_CONVERSATIONS = {"ID","BODY_TEXT","BODY","INCOMING",
                "TICKETS_CONVERSATIONS_PRIVATE","USER_ID","SUPPORT_EMAIL","SOURCE", "CATEGORY", "AUTO_RESPONSE",
                "IS_OFFLINE_NOTE", "TICKET_ID","EMAIL_CONFIG_ID", "CREATED_AT",
                "UPDATED_AT","FROM_EMAIL","TO_EMAILS","CC_EMAILS","BCC_EMAILS","ATTACHMENTS",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS",
                "__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        ...
        public static final String[] TICKETS = {"ID","CC_EMAILS","FWD_EMAILS","REPLY_CC_EMAILS","FR_ESCALATED",
                "SPAM","EMAIL_CONFIG_ID","GROUP_ID","PRIORITY","REQUESTER_ID","RESPONDER_ID","SOURCE","STATUS",
                "SUBJECT","TO_EMAILS","PRODUCT_ID","TICKETS_TYPE","CREATED_AT","UPDATED_AT","DUE_BY","FR_DUE_BY",
                "IS_ESCALATED","STRUCTURED_DESCRIPTION","CUSTOM_FIELDS", "TAGS", "__ROW_MD5","__DLH_IS_DELETED",
                "__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
        public static final String[] TIME_ENTRIES = {"ID","BILLABLE","NOTE","TIMER_RUNNING","AGENT_ID","TICKET_ID",
                "TIME_SPENT","CREATED_AT","UPDATED_AT","EXECUTED_AT","START_TIME", "COMPANY_ID", "TIME_SPENT_IN_SECONDS",
                "__ROW_MD5","__DLH_IS_DELETED","__DLH_SYNC_TS","__DLH_START_TS","__DLH_FINISH_TS","__DLH_IS_ACTIVE"};
    ...
    public static final Map<String, List<String>> ENTITY_DEPENDENCY_MAP = Map.ofEntries(
            Map.entry(FreshDeskEntityNames.TICKETS, List.of(FreshDeskEntityNames.TICKETS_CONVERSATIONS,
                    FreshDeskEntityNames.TICKETS_SATISFACTION_RATINGS, FreshDeskEntityNames.TICKETS_SUMMARY)),
    ...
    public static Map<String, String> getEntityApiPathMap() {
        ...
        ENTITY_API_PATH_MAP.put(FreshDeskEntityNames.TICKETS_SUMMARY, URI_PREFIX_WITH_VERSION + "tickets/{tickets_id}/summary");
        ENTITY_API_PATH_MAP.put(FreshDeskEntityNames.CANNED_RESPONSES, URI_PREFIX_WITH_VERSION +
                "canned_response_folders/{canned_response_folders_id}/responses");
    ...
    public static final Map<String, String> MAPPING_TABLES_MAP = Map.ofEntries(
            Map.entry(FreshDeskEntityNames.SURVEYS, FreshDeskEntityNames.SURVEYS_QUESTIONS),
            Map.entry(FreshDeskEntityNames.CANNED_RESPONSES, FreshDeskEntityNames.CANNED_RESPONSES_ATTACHMENTS)
    );

    public static final Map<String, String[]> CHILD_TABLE_HEADERS_BY_ENTITY = Map.ofEntries(
            Map.entry(FreshDeskEntityNames.SURVEYS_QUESTIONS, FreshDeskHeaders.SURVEYS_QUESTIONS),
            Map.entry(FreshDeskEntityNames.CANNED_RESPONSES_ATTACHMENTS, FreshDeskHeaders.CANNED_RESPONSES_ATTACHMENTS)
    );
