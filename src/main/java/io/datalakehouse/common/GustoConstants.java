...
public class GustoConstants {
    ...
    public static final class GustoHeaders {
        ...
        public static final String[] COMPANY_ADMINS = {"UUID", "FIRST_NAME", "LAST_NAME", "EMAIL", "__ROW_MD5",
                "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] CUSTOM_FIELDS = {"UUID", "NAME", "DESCRIPTION", "TYPE", "SELECTION_OPTIONS",
        ...
        public static final String[] PAY_SCHEDULES = {"UUID", "VERSION", "FREQUENCY", "ANCHOR_PAY_DATE",
                "ANCHOR_END_OF_PAY_PERIOD", "DAY_1", "DAY_2", "NAME", "CUSTOM_NAME", "AUTOPILOT", "ACTIVE", "__ROW_MD5",
                "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        ...
        public static final String[] PAY_PERIODS = {"START_DATE", "END_DATE", "PAY_SCHEDULE_UUID", "PAYROLL_UUID",
                ...
                "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] EARNING_TYPES = {"UUID", "NAME", "__ROW_MD5", "__DLH_IS_DELETED", "__DLH_SYNC_TS",
                "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] PAYROLLS = {"UUID", "EMPLOYEE_COMPENSATIONS", "SUBMISSION_BLOCKERS",
                "CREDIT_BLOCKERS", "PAYROLL_UUID", "COMPANY_UUID", "OFF_CYCLE", "AUTO_PILOT", "PROCESSED",
                "PROCESSED_DATE", "CALCULATED_AT", "PAY_PERIOD_START_DATE", "PAY_PERIOD_END_DATE",
                "PAY_PERIOD_PAY_SCHEDULE_UUID", "PAY_PERIOD_ID", "PAYROLL_STATUS_META_CANCELLABLE",
                "PAYROLL_STATUS_META_EXPECTED_CHECK_DATE", "PAYROLL_STATUS_META_INITIAL_CHECK_DATE",
                "PAYROLL_STATUS_META_EXPECTED_DEBIT_TIME", "PAYROLL_STATUS_META_PAYROLL_LATE",
                "PAYROLL_STATUS_META_INITIAL_DEBIT_CUTOFF_TIME", "CHECK_DATE", "PAYROLLS_EXTERNAL", "PAYROLL_DEADLINE",
                "PROCESSING_REQUEST_ID", "COMPANY_TAXES", "CREATED_AT", "PARTNER_OWNED_DISBURSEMENT",
                "TOTAL_EMPLOYEE_BONUSES", "TOTAL_EMPLOYEE_COMMISSIONS", "TOTAL_EMPLOYEE_CASH_TIPS",
                "TOTAL_EMPLOYEE_PAYCHECK_TIPS", "TOTAL_ADDITIONAL_EARNINGS", "TOTAL_OWNERS_DRAW", "TOTAL_BENEFITS",
                "TOTAL_CHECK_AMOUNT", "TOTAL_CHILD_SUPPORT_DEBIT", "TOTAL_COMPANY_DEBIT",
                "TOTAL_DEFERRED_PAYROLL_TAXES", "TOTAL_EMPLOYEE_BENEFITS_DEDUCTIONS", "TOTAL_EMPLOYEE_TAXES",
                "TOTAL_EMPLOYER_TAXES", "TOTAL_GROSS_PAY", "TOTAL_IMPUTED_PAY", "TOTAL_NET_PAY", "TOTAL_NET_PAY_DEBIT",
                "TOTAL_OTHER_DEDUCTIONS", "TOTAL_REIMBURSEMENT_DEBIT", "TOTAL_REIMBURSEMENTS", "TOTAL_TAX_DEBIT",
                "PROCESSING_REQUEST_STATUS", "PROCESSING_REQUEST_ERRORS", "__ROW_MD5", "__DLH_IS_DELETED",
        ...
        public static final String[] BENEFITS = {"BENEFIT_TYPE", "NAME", "DESCRIPTION", "PRETAX", "POSTTAX", "IMPUTED",
                ...
                "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] DEPARTMENTS = {"UUID", "COMPANY_UUID", "TITLE", "VERSION", "EMPLOYEES",
                "CONTRACTORS", "__ROW_MD5", "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS",
                "__DLH_IS_ACTIVE"};
        ...
        public static final String[] EMPLOYEES = {"UUID", "FIRST_NAME", "MIDDLE_INITIAL", "LAST_NAME", "EMAIL",
                ...
                "ONBOARDING_DOCUMENTS_CONFIG", "CURRENT_HOME_ADDRESS", "ELIGIBLE_PAID_TIME_OFF", "TERMINATIONS",
                "GARNISHMENTS", "DATE_OF_BIRTH", "SSN", "PHONE", "WORK_EMAIL", "__ROW_MD5", "__DLH_IS_DELETED",
                "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        ...
        public static final String[] JOBS = {"UUID", "VERSION", "EMPLOYEE_UUID", "CURRENT_COMPENSATION_UUID",
                "PAYMENT_UNIT", "JOBS_PRIMARY", "TITLE", "STATE_WC_COVERED", "STATE_WC_CLASS_CODE", "RATE", "HIRE_DATE",
                "__ROW_MD5", "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS",
                "__DLH_IS_ACTIVE"};
        public static final String[] JOBS_COMPENSATIONS = {"UUID", "JOBS_ID", "VERSION", "PAYMENT_UNIT", "FLSA_STATUS",
        ...
        public static final String[] EMPLOYEE_BENEFITS = {"UUID", "VERSION", "EMPLOYEE_UUID", "COMPANY_BENEFIT_UUID",
                "ACTIVE", "EMPLOYEE_DEDUCTION", "EMPLOYEE_DEDUCTION_ANNUAL_MAXIMUM",
        ...
        public static final String[] GARNISHMENTS = {"UUID", "VERSION", "EMPLOYEE_UUID", "ACTIVE", "AMOUNT",
                ...
                "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] CONTRACTORS = {"ID", "UUID", "COMPANY_UUID", "COMPANY_ID", "WAGE_TYPE",
                ...
                "ONBOARDED", "ONBOARDING_STATUS", "CONTRACTOR_ADDRESS_STREET_1", "CONTRACTOR_ADDRESS_STREET_2",
                "CONTRACTOR_ADDRESS_CITY", "CONTRACTOR_ADDRESS_STATE", "CONTRACTOR_ADDRESS_ZIP",
                "CONTRACTOR_ADDRESS_COUNTRY", "HOURLY_RATE", "__ROW_MD5", "__DLH_IS_DELETED", "__DLH_SYNC_TS",
                "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] CONTRACTOR_PAYMENTS = {"CONTRACTOR_ID", "REIMBURSEMENT_TOTAL", "WAGE_TOTAL",
                "PAYMENTS", "__ROW_MD5", "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS", "__DLH_FINISH_TS",
                "__DLH_IS_ACTIVE"};
        public static final String[] RECURRING_REIMBURSEMENTS = {"UUID", "EMPLOYEE_UUID", "VERSION", "DESCRIPTION",
                ...
                "__DLH_START_TS", "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
        public static final String[] TOKEN_INFO = {"SCOPE", "RESOURCE_TYPE", "RESOURCE_UUID", "RESOURCE_OWNER_TYPE",
                "RESOURCE_OWNER_UUID", "__ROW_MD5", "__DLH_IS_DELETED", "__DLH_SYNC_TS", "__DLH_START_TS",
                "__DLH_FINISH_TS", "__DLH_IS_ACTIVE"};
    ...
    public static final Map<String, List<String>> ENTITY_DEPENDENCY_MAP = Map.ofEntries(
            Map.entry(GustoEntityNames.EMPLOYEES,
                    List.of(GustoEntityNames.EMPLOYEE_HOME_ADDRESSES, GustoEntityNames.EMPLOYEE_WORK_ADDRESSES,
                            ...
                            GustoEntityNames.RECURRING_REIMBURSEMENTS)),
